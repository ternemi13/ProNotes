...
ProNotes es un cuaderno digital de escritorio para Windows, creado con C#/.NET y WPF. Esta primera entrega implementa el nucleo del spec: biblioteca de cuadernos, formato `.cdgz`, paginas, escritura/dibujo con `InkCanvas`, fondos de hoja, herramientas de tinta, zoom y autoguardado.
...
- Fase 3: imagenes movibles y recortables.
- Fase 4: cajas de texto, tablas y graficas.
