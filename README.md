...
- Fase 7: asistente Gemini implementado en el panel lateral, con API key cifrada localmente, preguntas generales, revision visual de la pagina actual e historial por cuaderno.
